...
class CSPResNet(nn.Layer):
    ...
    def __init__(self,
        ...
        self.norm = nn.BatchNorm(1024) 
        self.fc_cls = nn.Linear(1024,1000)
    ...
    def forward(self, inputs):
        ...
        return self.fc_cls(self.norm(x.mean([-2, -1])))
...
def CSPResNet_tiny(pretrained=False, use_ssld=False, **kwargs):
    # [1, 1, 3, 1] [32, 32, 64, 128, 256]
    # Total Flops: 0.065G     Total Params: 0.43MB
    model = CSPResNet(**kwargs)
    _load_pretrained(
